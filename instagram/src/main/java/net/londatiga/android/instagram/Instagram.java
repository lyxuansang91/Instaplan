...
public class Instagram {
	...
	public Instagram(Context context, String clientId, String clientSecret, String redirectUri) {
		...
		authUrl	= Cons.AUTH_URL + "client_id=" + mClientId + "&redirect_uri=" + mRedirectUri + "&response_type=code";
	...
	public void authorize(InstagramAuthListener listener) {
		...
		mDialog 		= new InstagramDialog(mContext, authUrl, mRedirectUri, new InstagramDialog.InstagramDialogListener() {
